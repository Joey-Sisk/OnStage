            ...
            features: [
              {
                ...
                geometry: {
                  type: "Point",
                  coordinates: [
                    eventData[0].venue.longitude,
                    eventData[0].venue.latitude,
                  ],
                },
                properties: {
              ...
              },
              {
                ...
                geometry: {
                  type: "Point",
                  coordinates: [
                    eventData[1].venue.longitude,
                    eventData[1].venue.latitude,
                  ],
                },
                properties: {
              ...
              {},
              {
                ...
                geometry: {
                  type: "Point",
                  coordinates: [
                    eventData[2].venue.longitude,
                    eventData[2].venue.latitude,
                  ],
                },
                properties: {
              ...
              {},
              {
                ...
                geometry: {
                  type: "Point",
                  coordinates: [
                    eventData[3].venue.longitude,
                    eventData[3].venue.latitude,
                  ],
                },
                properties: {
              ...
              },
              {
                ...
                geometry: {
                  type: "Point",
                  coordinates: [
                    eventData[4].venue.longitude,
                    eventData[4].venue.latitude,
                  ],
                },
                properties: {
